...
2. Diagrama UML a elaborar:
   ...
   <br>![](../img/C1.4_CU_Empleado.drawio.png)
   ![](../img/C1.4_CU_Entrenador.drawio.png)
   ![](../img/C1.4_CU_Coordinador.drawio.png)
   + Diagrama de **de secuencia**
   <br>![](../img/C1.4_DiagramaSecuenciav1.drawio.png)
   + Diagrama de **clases**
   <br>![](../img/C1.4_Diagramaclasev1.drawio.png)
___
