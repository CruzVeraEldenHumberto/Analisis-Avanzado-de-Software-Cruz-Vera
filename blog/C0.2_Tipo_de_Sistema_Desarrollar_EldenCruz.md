...
1. Apoyado de la información mostrada por el asesor, realice una investigación, donde se pueda dar respuesta a los siguientes puntos:
  ...
  - Identifique a que tipo de sistema esta referido el caso de estudio y porque cae en esta categoría. 
     >Vendría siendo un LMS, debido a que este sistema se especializa en administrar, distribuir y controlar actividades de formación no presencial.
  - Describa las características que debe tener el caso de estudio para cumplir con el tipo de sistema.
    >Gestión de cursos y catálogos: Permite a los administradores generar y gestionar distintos cursos y a los usuarios buscar e inscribirse a uno o varios cursos.<br></br>
    >Certificación y reentrenamiento: El sistema no solo certifica a sus usuarios, sino que también le permite volver a capacitar a los empleados para renovar las certificaciones a tiempo y evitar la caducidad. <br></br>
    >Centralización: Un LMS permite centralizar la información y los contenidos de uno o varios cursos ahorrando tiempo a los alumnos y facilitando la localización de todos los contenidos. <br></br>
    >Evaluación continua: Muchos usuarios puedan ser evaluados antes de comenzar un curso, durante su aprendizaje y tras la finalización de la acción formativa. 
